...
* The power switch pin header is for connecting a standard momentary switch to control the ATX power supply's on/off state. You can wire it to your ATX case's power switch.
